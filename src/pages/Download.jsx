                ...
                {filteredNotices.map((notice) => (
                  ...
                  >
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-center gap-2 sm:gap-4">
                      ...
                      <Link
                        to="/contact"
                        className="w-full sm:w-auto px-3 py-2 sm:px-4 sm:py-2 text-sm sm:text-base bg-red-600 text-white rounded-lg hover:bg-red-700 transition-all duration-300 text-center"
                      >
                        Enquiry Now
                      </Link>
                    </div>
